...
public class TC002_MouseHoverActionAndWindowHandle {
	WebDriver driver;
	...
	@Test(priority=1)
	public void RightClickMouseHoverAction() throws InterruptedException 
	{
		PageScroll_JavascriptExecutorUtility pageScroll = new PageScroll_JavascriptExecutorUtility(driver);
		pageScroll.scrollDownBotomOfPage();
